...
public class ExportBookingsTest extends SetUp {
	...
	public void exportBookingsTest() throws Exception {
		 ...
		 * "Capturing text of the export at top left corner of list......."); String
		 * booking =
		 * driver.findElements(exportPage.exportLabel).get(0).getAttribute("innerHTML");
		 * System.out.println(booking);
		 * 
		 * getExtTest().log(Status.INFO,
		 * "Validating that the latest export is made for bookings.......");
		 * Assert.assertEquals(booking, "Booking Details", "Not matched");
		 */
		...
		Assert.assertEquals(exportStatus, "working", "Export is completed successfully");
