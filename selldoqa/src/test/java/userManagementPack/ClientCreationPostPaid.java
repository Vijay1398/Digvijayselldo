...
public class ClientCreationPostPaid extends SetUp {
	...
	public void creatingClientfromSupport() throws Exception {
		...
		getExtTest().log(Status.INFO, "Entering Bussiness Type.......");
		createClientForm.enterBussinessType();
		
		getExtTest().log(Status.INFO, "Entering Transactional SMS Mask.......");
		createClientForm.enterTransactionalSmsMask();
		...
		//etExtTest().log(Status.INFO, "Entering Client Phone Number.......");
